          ...
          <ul className="navbar-nav nav nav-pills me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <a
                ...
                className={currentPage === 'About' ? 'nav-link active text-light fs-5' : 'nav-link text-dark fs-5'}
              >
                About
              </a>
            </li>
            <li className="nav-item">
              <a
                ...
                className={currentPage === 'Portfolio' ? 'nav-link active text-light fs-5' : 'nav-link text-dark fs-5'}
              >
                Portfolio
              </a>
            </li>
            <li className="nav-item">
              <a
                ...
                className={currentPage === 'Resume' ? 'nav-link active text-light fs-5' : 'nav-link text-dark fs-5'}
              >
                Resume
              </a>
            </li>
            <li className="nav-item">
              <a
                ...
                className={currentPage === 'Contact' ? 'nav-link active text-light fs-5' : 'nav-link text-dark fs-5'}
              >
                Contact
              </a>
            </li>
