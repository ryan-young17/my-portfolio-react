    ...
    <div className='container'>
      ...
      <div className='d-flex justify-content-center'>
        <p className='text-light'>
          If you're interested and would like to collaborate or learn more, please feel free to contact me via email at <a className='text-primary' href='mailto:ryanbyoung1@gmail.com'>ryanbyoung1@gmail.com</a>. I look forward to hearing from you!
        </p>
      </div>
    </div>
